...
const Body = () => {
  ...
  const handleQuery = async () => {
    ...
    } = await axios.post('/api/query', {type: queryType, string: queryString}) // TODO: axios.xxx call the right api
  ...
  return (
    <Wrapper>
      ...
      <Row>
        ...
        <TextField
          placeholder="please check the format in README file first"
          value={queryString}
